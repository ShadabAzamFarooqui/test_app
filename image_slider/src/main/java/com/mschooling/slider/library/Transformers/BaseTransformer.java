package com.mschooling.slider.library.Transformers;
 ...
 *
 * BaseTransformer implement {@link com.mschooling.slider.library.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link com.mschooling.slider.library.Tricks.ViewPagerEx}
 * when your slider are animating.
 *
 * In onPreTransform() function, that will make {@link com.mschooling.slider.library.Animations.BaseAnimationInterface}
 * work.
 *
