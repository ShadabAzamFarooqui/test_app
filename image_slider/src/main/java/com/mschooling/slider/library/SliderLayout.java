package com.mschooling.slider.library;
...
import com.mschooling.slider.library.Animations.BaseAnimationInterface;
import com.mschooling.slider.library.Indicators.PagerIndicator;
import com.mschooling.slider.library.SliderTypes.BaseSliderView;
import com.mschooling.slider.library.Transformers.AccordionTransformer;
import com.mschooling.slider.library.Transformers.BackgroundToForegroundTransformer;
import com.mschooling.slider.library.Transformers.BaseTransformer;
import com.mschooling.slider.library.Transformers.CubeInTransformer;
import com.mschooling.slider.library.Transformers.DefaultTransformer;
import com.mschooling.slider.library.Transformers.DepthPageTransformer;
import com.mschooling.slider.library.Transformers.FadeTransformer;
import com.mschooling.slider.library.Transformers.FlipHorizontalTransformer;
import com.mschooling.slider.library.Transformers.FlipPageViewTransformer;
import com.mschooling.slider.library.Transformers.ForegroundToBackgroundTransformer;
import com.mschooling.slider.library.Transformers.RotateDownTransformer;
import com.mschooling.slider.library.Transformers.RotateUpTransformer;
import com.mschooling.slider.library.Transformers.StackTransformer;
import com.mschooling.slider.library.Transformers.TabletTransformer;
import com.mschooling.slider.library.Transformers.ZoomInTransformer;
import com.mschooling.slider.library.Transformers.ZoomOutSlideTransformer;
import com.mschooling.slider.library.Transformers.ZoomOutTransformer;
import com.mschooling.slider.library.Tricks.FixedSpeedScroller;
import com.mschooling.slider.library.Tricks.InfinitePagerAdapter;
import com.mschooling.slider.library.Tricks.InfiniteViewPager;
...
/**
 * SliderLayout is compound layout. This is combined with {@link com.mschooling.slider.library.Indicators.PagerIndicator}
 * and {@link com.mschooling.slider.library.Tricks.ViewPagerEx} .
 *
...
public class SliderLayout extends RelativeLayout{
    ...
    /**
     * {@link com.mschooling.slider.library.Tricks.ViewPagerEx} indicator.
     */
    private PagerIndicator mIndicator;


    /**
     * A timer and a TimerTask using to cycle the {@link com.mschooling.slider.library.Tricks.ViewPagerEx}.
     */
    private Timer mCycleTimer;
    private TimerTask mCycleTask;

    /**
     * For resuming the cycle, after user touch or click the {@link com.mschooling.slider.library.Tricks.ViewPagerEx}.
     */
    private Timer mResumingTimer;
    private TimerTask mResumingTask;

    /**
     * If {@link com.mschooling.slider.library.Tricks.ViewPagerEx} is Cycling
     */
    private boolean mCycling;

    /**
     * Determine if auto recover after user touch the {@link com.mschooling.slider.library.Tricks.ViewPagerEx}
     */
    ...
    /**
     * {@link com.mschooling.slider.library.Tricks.ViewPagerEx} transformer time span.
     */
    ...
    /**
     * Visibility of {@link com.mschooling.slider.library.Indicators.PagerIndicator}
     */
    private PagerIndicator.IndicatorVisibility mIndicatorVisibility = PagerIndicator.IndicatorVisibility.Visible;

    /**
     * {@link com.mschooling.slider.library.Tricks.ViewPagerEx} 's transformer
     */
    private BaseTransformer mViewPagerTransformer;

    /**
     * @see com.mschooling.slider.library.Animations.BaseAnimationInterface
     */
    private BaseAnimationInterface mCustomAnimation;

    /**
     * {@link com.mschooling.slider.library.Indicators.PagerIndicator} shape, rect or oval.
     */
     ...
     * {@link com.mschooling.slider.library.Animations.BaseAnimationInterface},
     * and you can see a example in {@link com.mschooling.slider.library.Animations.DescriptionAnimation}
     * @param animation
     */
    ...
    /**
     * get the {@link com.mschooling.slider.library.Indicators.PagerIndicator} instance.
