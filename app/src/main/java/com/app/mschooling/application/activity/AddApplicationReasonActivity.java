...
public class AddApplicationReasonActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbarClick(getString(R.string.add_application_reason));
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!reason.getText().toString().trim().isEmpty()) {
                    AddApplicationReasonRequest request = new AddApplicationReasonRequest();
                    request.setTitle(reason.getText().toString().trim());
                    apiCallBack(getApiCommonController().addApplicationReason(request));
                }else {
    ...
    @Subscribe
    public void addApplicationReason(AddApplicationReasonResponse response){
