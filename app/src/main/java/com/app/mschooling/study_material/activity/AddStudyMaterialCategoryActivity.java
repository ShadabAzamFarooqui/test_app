...
public class AddStudyMaterialCategoryActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_study_material_category_activity);
...
//        description.setText("https://www.youtube.com/watch?v=RciE68Q7PCA");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AddStudyCategoryRequest request = new AddStudyCategoryRequest();
                request.setId(id);
                ...
                apiCallBack(getApiCommonController().addStudyMaterialCategory(request));
            }
        });
...
//                    subject.setText("");
    ...
    @Subscribe
    public void notice(AddStudyCategoryResponse response) {
