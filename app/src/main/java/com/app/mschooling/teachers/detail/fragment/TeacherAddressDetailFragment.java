...
public class TeacherAddressDetailFragment extends BaseFragment {

    UpdateTeacherRequest mRequest = new UpdateTeacherRequest();
    TeacherAddressResponse response;
    String enrollmentId;
    ...
    public TeacherAddressDetailFragment(GetTeacherDetailResponse response) {
        this.response = response.getTeacherDetailResponse().getTeacherAddressResponse();
