...
public class ComplaintReasonListAdapter extends RecyclerView.Adapter<ComplaintReasonListAdapter.ViewHolder> {

    private Activity context;
    public static  List<ComplainReasonResponse> mDetailList;
    TreeMap<Integer, String> map;


    public ComplaintReasonListAdapter(Activity context, List<ComplainReasonResponse> data) {
