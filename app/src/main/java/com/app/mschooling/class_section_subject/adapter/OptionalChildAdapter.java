...
public class OptionalChildAdapter extends RecyclerView.Adapter<OptionalChildAdapter.ViewHolder> {
    ...
    int groupPosition;
    List<SubjectResponseModel.OptionSubject> baseList;
    OptionalBaseAdapter adapter;


    public OptionalChildAdapter(Activity context, String classId, String className, List<SubjectResponse> childList,
                                int groupPosition,
                                List<SubjectResponseModel.OptionSubject> baseList,
                                OptionalBaseAdapter adapter) {
