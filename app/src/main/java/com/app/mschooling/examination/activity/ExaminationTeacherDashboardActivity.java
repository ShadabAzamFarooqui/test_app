...
public class ExaminationTeacherDashboardActivity extends BaseActivity {

    @BindView(R.id.exams)
    LinearLayout exams;
    @BindView(R.id.createResult)
    LinearLayout createResult;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_examination_dashboard_teacher);
