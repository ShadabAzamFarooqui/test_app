...
public class FetchAddressIntentService extends IntentService {
     ...
     * Note: We define a {@link ResultReceiver} in * OcrMainActivity to process content
    ...
    private void deliverResultToReceiver(int resultCode, String message, Address address) {
        try {
            ...
            System.out.println("TTTTTTTTT "+address.getSubLocality());
            System.out.println("TTTTTTTTT "+address.getLocality());
            System.out.println("TTTTTTTTT "+address.getAddressLine(0));
