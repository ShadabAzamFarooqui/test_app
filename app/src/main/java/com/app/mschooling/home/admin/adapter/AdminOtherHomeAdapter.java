...
import com.app.mschooling.application.activity.ApplicationReasonListActivity;
...
import com.app.mschooling.complaint.activity.ComplaintReasonListActivity;
import com.app.mschooling.event.activity.EventsActivity;
import com.app.mschooling.examination.activity.ExaminationDashboardActivity;
...
import com.app.mschooling.piechart.ChartCreateActivity;
import com.app.mschooling.prayer.activity.PrayerListActivity;
import com.app.mschooling.quiz.activity.QuizDashboardActivity;
...
public class AdminOtherHomeAdapter extends RecyclerView.Adapter<AdminOtherHomeAdapter.ViewHolder> {

    private final Activity context;
    private final List<Menu> data;

    public AdminOtherHomeAdapter(Activity context, List<Menu> data) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, @SuppressLint("RecyclerView") int position) {
        ...
        if (data.get(position).getName().equals("Dashboard")) {
            viewHolder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.dashboard));
        } else if (data.get(position).getName().equals("Report")) {
            viewHolder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.report));
        } else if (data.get(position).getName().equals("Examination")) {
            viewHolder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.examination));
        } else if (data.get(position).getName().equals("Gallery")) {
            viewHolder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.gallary));
        } else if (data.get(position).getName().equals("Notice")) {
            viewHolder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.notice));
        } else if (data.get(position).getName().equals("Complaint")) {
            viewHolder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.complaint));
        } else if (data.get(position).getName().equals("Application")) {
            viewHolder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.inbox));
        } else if (data.get(position).getName().equals("Broadcast")) {
            viewHolder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.broad_cast));
        ...
        } else if (data.get(position).getName().equals("Parent")) {
            viewHolder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.parent));
        } else if (data.get(position).getName().equals("Discussion")) {
            viewHolder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.meeting));
        } else if (data.get(position).getName().equals("Events")) {
            viewHolder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.events));
        } else if (data.get(position).getName().equals("Quiz") || data.get(position).getName().equals("Assign Quiz")) {
            viewHolder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.quiz));
        ...
        } else if (data.get(position).getName().contains("Complaint Reason")) {
            viewHolder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.reason));
        } else if (data.get(position).getName().equals("Application Reason")) {
            viewHolder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.reason));
...
//        Helper.setTextGradient(context,viewHolder.tittle);
    ...
    void intent(int position) {
        if (data.get(position).getName().equals("Dashboard")) {
            context.startActivity(new Intent(context, ChartCreateActivity.class));
        } else if (data.get(position).getName().equals("Gallery")) {
            ...
            context.startActivity(new Intent(context, QuizDashboardActivity.class));
...
//                context.startActivity(new Intent(context, SetupZoomActivity.class));
            ...
            context.startActivity(new Intent(context, ComplaintReasonListActivity.class));
        } else if (data.get(position).getName().equals("Application Reason")) {
            context.startActivity(new Intent(context, ApplicationReasonListActivity.class));
        } else if (data.get(position).getName().equals("Video")) {
            ...
            context.startActivity(new Intent(context, ExaminationDashboardActivity.class));
        } else if (data.get(position).getName().equals("Std. Material")) {
            Intent intent = new Intent(context, AppendedClassListActivity.class);
