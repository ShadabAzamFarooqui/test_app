package com.app.mschooling.home.teacher.activity;
...
import com.app.mschooling.teachers.profile.activity.TeacherProfileActivity;
...
import com.app.mschooling.attendance.teacher.fragment.MarkTeacherAttendanceFragment;
import com.app.mschooling.teachers.profile.fragment.TeacherTimeTableAllocationFragment;
import com.app.mschooling.home.teacher.fragment.TeacherHomeFragment;
import com.app.mschooling.menu.TeacherMenuFragment;
...
public class TeacherMainActivity extends BaseActivity {
    ...
    public static TeacherMainActivity context;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.navigation_complaint:
                    fragment = new MarkTeacherAttendanceFragment();
                    break;
                case R.id.navigation_notice:
                    fragment = new TeacherTimeTableAllocationFragment();
                    break;
                case R.id.navigation_menu:
                    fragment = new TeacherMenuFragment();

            }
            return TeacherMainActivity.this.loadFragment(fragment);
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateToken();
        setContentView(R.layout.activity_main_teacher_navigation);
        context = this;
...
//        AdmobHelper.showInterstitialAds(this);
    ...
    void navigationDrawer() {
        ...
        showTimeTable.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                drawer.closeDrawer(GravityCompat.START);
                startActivity(new Intent(getApplicationContext(), ClassTimeTableActivity.class));
            }
        });
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                drawer.closeDrawer(GravityCompat.START);
                Helper.share(TeacherMainActivity.this);
            }
        });
