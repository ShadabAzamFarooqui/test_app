...
public class UploadHomeWorkAdapter extends RecyclerView.Adapter<UploadHomeWorkAdapter.ViewHolder> {
    ...
    public UploadHomeWorkAdapter(Activity context, List<Image> uri, LinearLayout insertImage) {
